...
print_summary() {
    ...
    echo ""
    echo "pgbench Tests:"
    echo "  - Initialize:        pgbench -i -s 10 -U postgres -h localhost -p 9999 postgres"
    echo "  - Read/Write test:   pgbench -c 10 -t 10 -U postgres -h localhost -p 9999 postgres"
    echo "  - Read-only test:    pgbench -c 10 -t 10 -U postgres -h localhost -p 9999 postgres -S"
    echo ""
    echo "==============================================================================="
}
